...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>ELIS</b>SGC</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <small class="label pull-right bg-green">1</small>
               ...
               <li>
                    <a href="#">
                        <i class="fa fa-clock-o"></i> <span>Resevas</span>
                        <span class="pull-right-container">
              ...
              <small class="label pull-right bg-blue">17</small>
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-exclamation-triangle"></i> <span>Ocorrencias</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-red">3</small>
              <small class="label pull-right bg-blue">17</small>
            </span>
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-ticket"></i> <span>Chegadas</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-blue">17</small>
            </span>
                    </a>
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-th"></i> <span>Enquetes</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-blue">17</small>
            </span>
                    </a>
